...
const navItems: readonly NavItem[] = [
  { id: 0, icon: Landmark, label: "Accueil", href: "/centre_general", category: "main", tone: "blue" },
  { id: 1, icon: Home, label: "Invitations", href: "/centre_general/invitations", category: "main", tone: "yellow" },
  { id: 2, icon: UserPlus, label: "A-Actives", href: "/centre_general/a-actives", category: "main", tone: "blue" },

  { id: 3, icon: Store, label: "Boutiques", href: "/centre_general/boutiques", category: "operations", tone: "yellow" },
  { id: 4, icon: FileText, label: "Abonnements", href: "/centre_general/abonnements", category: "operations", tone: "blue" },
  { id: 5, icon: Coins, label: "Zaïmu", href: "/centre_general/zaimu", category: "operations", tone: "yellow" },
  { id: 6, icon: UserCheck, label: "Utilisateurs actifs", href: "/centre_general/utilisateurs-actifs", category: "operations", tone: "red" },
  { id: 7, icon: UserX, label: "Utilisateurs passifs", href: "/centre_general/utilisateurs-passifs", category: "operations", tone: "red" },
  { id: 8, icon: MapPinned, label: "Centres", href: "/centre_general/centres", category: "operations", tone: "blue" },
  { id: 9, icon: BookOpen, label: "Chapitres", href: "/centre_general/chapitres", category: "operations", tone: "yellow" },
  { id: 10, icon: UsersRound, label: "Groupes", href: "/centre_general/groupes", category: "operations", tone: "red" },
  { id: 11, icon: Layers, label: "Sous-groupes", href: "/centre_general/sous-groupes", category: "operations", tone: "blue" },
  { id: 12, icon: Users, label: "Membres", href: "/centre_general/membres", category: "operations", tone: "yellow" },
  { id: 13, icon: LayoutGrid, label: "Départements", href: "/centre_general/departements", category: "operations", tone: "red" },

  { id: 14, icon: MessageSquare, label: "Messages", href: "/centre_general/messages", category: "communication", tone: "blue" },
] as const;
...
function isNavActive(pathname: string, href: string) {
  ...
  if (href === "/centre_general") return false;
  return pathname.startsWith(`${href}/`);
}

const SidebarCentreGeneral = ({ isOpen }: { isOpen: boolean }) => {
...
export default SidebarCentreGeneral;
