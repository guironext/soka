...
import { SignInAutoContinue } from "@/components/auth/sign-in-auto-continue";
					...
					<div className="flex flex-col items-center gap-6">
						...
						<div className="space-y-2">
							...
							<p className="mx-auto max-w-sm text-pretty text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
								Espace membres — connectez-vous pour accéder à votre tableau de
								bord et à votre parcours d&apos;intégration.
							</p>
						</div>
					</div>
					<SignIn
