...
import SidebarCentreGeneral from "@/components/Sidebar_Centre_general";
//import SidebarCommercial from "../../../components/Sidebaradmin";
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      >
        <SidebarCentreGeneral isOpen={isSidebarOpen} />
      </div>
